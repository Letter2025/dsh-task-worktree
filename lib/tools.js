...
export function registerTools(ctx, manager) {
  ctx.tools.register(defineTool({
    ...
    description: '创建任务隔离的 worktree：在当前 Git 仓库新建独立 worktree（自动创建 worktree-<name> 分支），改动不影响主工作区，随后可打开该 worktree 目录作为新会话工作区。类似 Qoder 的 Worktree 执行环境与 Codex 的永久 worktree。',
    parameters: {
      name: {
        type: 'string',
        required: true,
        description: '任务名（作为 worktree 名与分支名，字母数字._-，不以 - 或 . 开头）。',
      },
      baseCommit: {
        type: 'string',
